  ...
  return (
    <div className="flex gap-[18px] md:gap-[12px] lg:gap-[22px] xl:gap-[28px] 2xl:gap-[32px] desktop:gap-[36px] ultra:gap-[52px]">
      ...
      <div className="flex flex-col">
        <p className="leading-tight font-poppins font-semibold text-[11px] lg:text-[15px] xl:text-[18px] 2xl:text-[20px] desktop:text-[22px] ultra:text-[33px]">
          {title}
        </p>
        <p className="text-[10px] lg:text-[13px] xl:text-[16px] 2xl:text-[18px] desktop:text-[20px] ultra:text-[29px]">
          {text}
        </p>
      </div>
    </div>
