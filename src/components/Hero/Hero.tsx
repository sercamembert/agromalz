...
const Hero = () => {
  return (
    <div className="padding pt-[100px] md:pt-[110px] lg:pt-[130px] xl:pt-[150px] 2xl:pt-[180px] desktop:pt-[160px] flex flex-col md:flex-row">
      <div className="flex flex-col gap-[10px] w-full md:max-w-[350px] lg:max-w-[463px] xl:max-w-[584px] 2xl:max-w-[657px] desktop:max-w-[709px] ultra:max-w-[1065px]">
        ...
        <p className="text-text text-[12px]  lg:text-[16px] xl:text-[20px] 2xl:text-[22px] desktop:text-[24px] ultra:text-[36px]  text-center md:text-left">
          ...
          prowadzą to gospodarstwo od pokoleń. Nasza rodzina dba o tradycję, ale
          również nieustannie rozwija się, wprowadzając nowoczesne technologie i
